...
nominal_frequency = 25 #nominal frequency of the power circuitry, measured in hertz
voltage_ripple = 5 #voltage ripple of the power circuitry, measured in volts
switching_frequency = 10 #1920 #switching frequency of the power circuitry, measured in hertz

#trigger pulse:
trigger_duty_cycle = 0
trigger_latency = 0
trigger_rise_time = 0
trigger_nominal_voltage = 0
