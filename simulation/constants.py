...
nominal_frequency_positive = 333333 #positive nominal frequency of the power circuitry, measured in hertz
nominal_frequency_negative = 333333 #negative nominal frequency of the power circuitry, measured in hertz
...
BCM_resolution = 1 #resolution with which the wave is "measured" by the BCM, measured in hertz
detector_resolution = 0.01 #resolution with which the wave is "measured" by the detector, measured in hertz
