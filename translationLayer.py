...
deadtime = 10 #beta * constants.capacitance * constants.nominal_voltage #measurment deadtime, calculation for the formula t = (beta)cv, measured in microseconds
...
transient_frequency = 1 / 0.00002 #transient frequency, measured in hertz
...
nominal_period = (1 / nominal_frequency) / 1000000 #period of the wave, measured in microseconds
transient_period = (1 / transient_frequency) / 1000000 #period of the transient, measured in microseconds
switching_period = (1 / switching_frequency) / 1000000 #period of the switching, measured in microseconds
