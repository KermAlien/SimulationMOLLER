...
num_of_microseconds_detector = ((len(detector_storage) * detector_resolution) / nominal_angular_frequency)
...
num_of_microseconds_BCM = ((len(BCM_storage) * BCM_resolution) / nominal_angular_frequency)
